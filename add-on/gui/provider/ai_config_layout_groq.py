...
class AIConfigLayoutGroq(AIConfigLayout):
    def __init__(self, config_window, conf) -> None:
        super().__init__(config_window, conf)
    ...
    def advanced(self):
        ...
        number_input.setValue(self.conf.get(self.get_key("temperature")))
        ...
        number_input.setValue(self.conf.get(self.get_key("max_tokens")))
        ...
        number_input.setValue(self.conf.get(self.get_key("presence_penalty")))
        ...
        number_input.setValue(self.conf.get(self.get_key("frequency_penalty")))
